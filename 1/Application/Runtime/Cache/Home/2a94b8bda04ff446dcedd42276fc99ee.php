...
<head>
	...
	<title>图书管理-后台系统</title>
	<link href="/xiaoyi/ThinkPHP3.2/Public/index/style/authority/main_css.css" rel="stylesheet" type="text/css" />
	<link href="/xiaoyi/ThinkPHP3.2/Public/index/style/authority/zTreeStyle.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="/xiaoyi/ThinkPHP3.2/Public/index/scripts/jquery/jquery-1.7.1.js"></script>
	<script type="text/javascript" src="/xiaoyi/ThinkPHP3.2/Public/index/scripts/zTree/jquery.ztree.core-3.2.js"></script>
	<script type="text/javascript" src="/xiaoyi/ThinkPHP3.2/Public/index/scripts/authority/commonAll.js"></script>
	<script type="text/javascript">
		/**退出系统**/
		function logout(){
			if(confirm("您确定要退出本系统吗？")){
				window.location.href = "/xiaoyi/ThinkPHP3.2/index.php/Home/Index/login.html";
			}
		}
...
<body onload="getDate01()">
    <div id="top">
		<div id="top_logo">
			<img alt="logo" src="/xiaoyi/ThinkPHP3.2/Public/index/images/common/logo.jpg" width="274" height="49" style="vertical-align:middle;">
		</div>
		<div id="top_links">
			<div id="top_op">
				<ul>
					<li>
						<img alt="当前用户" src="/xiaoyi/ThinkPHP3.2/Public/index/images/common/user.jpg">：
						<span>admin</span>
					</li>
					<li>
						<img alt="事务月份" src="/xiaoyi/ThinkPHP3.2/Public/index/images/common/month.jpg">：
						<span id="yue_fen"></span>
					</li>
					<li>
						<img alt="今天是" src="/xiaoyi/ThinkPHP3.2/Public/index/images/common/date.jpg">：
			...
			<div id="top_close">
				<a href="javascript:void(0);" onclick="logout();" target="_parent">
					<img alt="退出系统" title="退出系统" src="/xiaoyi/ThinkPHP3.2/Public/index/images/common/close.jpg" style="position: relative; top: 10px; left: 25px;">
				</a>
			</div>
		</div>
	</div>
		...
		<div id="left_menu">
		 	<ul id="TabPage2" style="height:200px; margin-top:50px;">
				<li id="left_tab1" class="selected" onClick="javascript:switchTab('TabPage2','left_tab1');" title="业务模块">
					<img alt="业务模块" title="业务模块" src="/xiaoyi/ThinkPHP3.2/Public/index/images/common/1_hover.jpg" width="33" height="31">
				</li>
				<li id="left_tab2" onClick="javascript:switchTab('TabPage2','left_tab2');" title="系统管理">
					<img alt="系统管理" title="系统管理" src="/xiaoyi/ThinkPHP3.2/Public/index/images/common/2.jpg" width="33" height="31">
				</li>		
				<li id="left_tab3" onClick="javascript:switchTab('TabPage2','left_tab3');" title="其他">
					<img alt="其他" title="其他" src="/xiaoyi/ThinkPHP3.2/Public/index/images/common/3.jpg" width="33" height="31">
				</li>
			</ul>
			...
			<div id="nav_show" style="position:absolute; bottom:0px; padding:10px;">
				<a href="javascript:;" id="show_hide_btn">
					<img alt="显示/隐藏" title="显示/隐藏" src="/xiaoyi/ThinkPHP3.2/Public/index/images/common/nav_hide.png" width="35" height="35">
				</a>
			</div>
		 </div>
		 <div id="left_menu_cnt">
		 	<div id="nav_module">
		 		<img src="/xiaoyi/ThinkPHP3.2/Public/index/images/common/module_1.png" width="210" height="58"/>
		 	</div>
		 	<div id="nav_resource">
	...
	<script type="text/javascript">
		$(function(){
			$('#TabPage2 li').click(function(){
				...
				$(this).find('img').attr('src', '/xiaoyi/ThinkPHP3.2/Public/index/images/common/'+ (index+1) +'_hover.jpg');
				$(this).css({background:'#fff'});
				$('#nav_module').find('img').attr('src', '/xiaoyi/ThinkPHP3.2/Public/index/images/common/module_'+ (index+1) +'.png');
				$('#TabPage2 li').each(function(i, ele){
					if( i!=index ){
						$(ele).find('img').attr('src', '/xiaoyi/ThinkPHP3.2/Public/index/images/common/'+ (i+1) +'.jpg');
		...
		function switchSysBar(flag){
			...
			if( flag==true ){	// flag==true
		        ...
		        if ( left_menu_cnt.is(":visible") ) {
		        	...
		        	$('#main').css({left:'60px'});
		        	$("#show_hide_btn").find('img').attr('src', '/xiaoyi/ThinkPHP3.2/Public/index/images/common/nav_show.png');
		        } else {
					left_menu_cnt.show(500, 'linear');
					side.css({width:'280px'});
					$('#top_nav').css({width:'77%', left:'304px', 'padding-left':'0px'});
		        	$('#main').css({left:'280px'});
		        	$("#show_hide_btn").find('img').attr('src', '/xiaoyi/ThinkPHP3.2/Public/index/images/common/nav_hide.png');
		        }
			}
		}
	</script>
    ...
    <div id="main">
      	<iframe name="right" id="rightMain" src="/xiaoyi/ThinkPHP3.2/index.php/Home/Index/introduce.html" frameborder="no" scrolling="auto" width="100%" height="100%" allowtransparency="true"/>
    </div>
