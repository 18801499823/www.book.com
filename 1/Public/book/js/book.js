...
/*循环显示的轮换横幅广告*/
 /*循环显示的图片地址*/	
     ...
     scorll_img[0]="http://www.book.com/Public/book/images/dd_scroll_1.jpg";
     scorll_img[1]="http://www.book.com/Public/book/images/dd_scroll_2.jpg";
     scorll_img[2]="http://www.book.com/Public/book/images/dd_scroll_3.jpg";
     scorll_img[3]="http://www.book.com/Public/book/images/dd_scroll_4.jpg";
     scorll_img[4]="http://www.book.com/Public/book/images/dd_scroll_5.jpg";
     scorll_img[5]="http://www.book.com/Public/book/images/dd_scroll_6.jpg";
	 /*按钮的ID编号*/
...
/*首页弹出广告窗口*/
window.open('__CONTROLLER__/open','','top=0,left=200,width=500,height=327,scrollbars=0,resizable=0'); 	
