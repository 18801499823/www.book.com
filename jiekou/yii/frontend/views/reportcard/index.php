	...
	<body>
		...
		<ul class="dorm-book mt3">
			...
			<li>
		        ...
		        <span class="info-middle"><?php echo $data[0]->username; ?></span>  
			</li>
			<li>
				<span class="book-tit">性别</span>
		        <span class="info-middle"><?php echo $data[0]->sex; ?></span>  
			</li>
			<li>
				<span class="book-tit">身份证号</span>
		        <span class="info-middle"><?php echo $data[0]->idNumber; ?></span>  
			</li>
			<li>
				<span class="book-tit">考生号</span>
		    <span class="info-middle"><?php echo $data[0]->number; ?></span>  
			</li>
			<li>
				<span class="book-tit">学院</span>
		        <span class="info-middle"><?php echo $data[0]->school; ?></span>  
			</li>
			<li>
				<span class="book-tit">专业</span>
		        <span class="info-middle"><?php echo $data[0]->job; ?></span>  
			</li>
			<li>
				<span class="book-tit">宿舍号</span>
		        <span class="info-middle"><?php echo $data[0]->roomNum; ?></span>  
			</li>
			<li>
				<span class="book-tit">铺位</span>
		        <span class="info-middle"><?php echo $data[0]->num; ?></span>  
			</li>
		</ul>
		<ul class="dorm-book mt3">
			<li class="basic-tit">
			...
			<?php foreach ($arr as $key => $value) { ?>
				<li class="cost clearfix">
					...
					<span><?php echo $value->ptype; ?></span>
